...
function CommonSection(props: Props) {
  ...
  React.useEffect(() => {
    ...
    if (categoryId !== undefined) {
      ...
      getCategoryProducts(SpotlightTypes.category, params, 0, DEFAULT_PAGE_SIZE);
    }
  }, [spotlightItem]);
  ...
  const categoryId = _.get(spotlightItem, 'category.categoryId');
  const data = _.get(categories, `${SpotlightTypes.category}_${categoryId}`);
