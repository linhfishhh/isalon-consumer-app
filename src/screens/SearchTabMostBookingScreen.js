...
import {getResultSearchTabMostBooking, updateSearchTabMostBookingState} from "../redux/search_tab_most_booking/actions";

type Props = {};

class SearchTabMostBookingScreen extends PureComponent<Props> {
    constructor(props) {
        super(props);
        this.state = {};
    }
    ...
    _loadMore = ()=>{
        this.props.getResultSearchTabMostBooking({}, false);
    };
...
export default connect(
    state => {
        return {
            ...
            tab: state.new_search_tab_most_booking
        }
    },
    {
